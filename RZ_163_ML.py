...
File for RZ163-ML Dose Calculator - multi-lamps per module
...
## Dose Coefficents
# RZM-11: - Base
LampPower = 1705  # [W] - 300W/cm for 140mm arc-length lamp
minFlow = 4  # [m3h]
maxFlow = 2000  # [m3h] #?
...
n_coeff_0 = -9.2390722222
n_coeff_1 = 0.2899138889
n_coeff_2 = -0.0018263889
n_limit = 1

L_eff_coeff_0 = 1418.38465650608
L_eff_coeff_1 = -79.6704348572632
L_eff_coeff_2 = 1.66066189728908
L_eff_coeff_3 = -0.015253483883655
L_eff_coeff_4 = 0.000052239759634

NL0 = 0.229714750061484
NL1 = 0.015132695105295
NL2 = -0.000074298426059
eta_g = 0.1156
UVT_step = 75
n_delta_ext = 16
q_min = 0.1
...
def RED(P1, P2, P3, P4, Eff1, Eff2, Eff3, Eff4, Flow, UVT, D1Log,
        NLamps):  # Here we shall modify for ML - P1,P2,P3,P4 Eff1,Eff2,Eff3,Eff4
    ...
    # PQR = NLamps * LampPower * (Eff1 / 100) / Flow
    PQR = NLamps * LampPower / Flow
