# -*- coding: utf-8 -*-
"""
File for RS-104 Dose Calculator - dual lamp per module
Created on Mon Nov 30 17:32:28 2020
...
## Dose Coefficents
# RZM-11: - Base
LampPower = 1045 #[W] - 300W/cm for 140mm arc-length lamp
minFlow = 1 #[m3h]
maxFlow = 1000 #[m3h]
...
n_coeff_0 = -338.153201108684
n_coeff_1 = 6.784162382758
n_coeff_2 = -0.030026377486
n_limit = 12.47

L_eff_coeff_0 =	943.537556579581
L_eff_coeff_1 =	-53.479800936044
L_eff_coeff_2 =	1.119891116076
L_eff_coeff_3 =	-0.010289398513
L_eff_coeff_4 =	0.000035131549

NL0 = 0.353922234366007
NL1 = 0.01090976049075
NL2 = -0.000044489828344
eta_g =	0.117982558336766
UVT_step = 75
n_delta_ext = 5
q_min = 0.1
...
def RED(P1,P2,Eff1,Eff2,Flow,UVT,D1Log,NLamps): #Here we shall modify for DL - P1,P2 Eff1, Eff2    
    ...
    PQR = NLamps*(LampPower*(P/100))/Flow
...
def HeadLoss(Flow,NLamps):
    ...
    if NLamps == 1:
        return round(HeadLossFactor*(C_Flow_SL*Flow**2)/100,2)
    if NLamps == 2:
        return round(HeadLossFactor*(C_Flow_DL*Flow**2)/100,2)