...
def RED(P1,P2,P3,P4,P5,P6,P7,P8,P9,P10,P11,Eff1,Eff2,Eff3,Eff4,Eff5,Eff6,Eff7,Eff8,
        Eff9,Eff10,Eff11,Flow,UVT,D1Log,NLamps):
    
    #This averaging is temporary and shall be changed on a more complicated model
    P = (P1+P2+P3+P4+P5+P6+P7+P8+P9+P10+P11)/11
    Eff = (Eff1+Eff2+Eff3+Eff4+Eff5+Eff6+Eff7+Eff8+Eff9+Eff10+Eff11)/11
...
def HeadLoss(Flow,NLamps):
    if NLamps == 11: #this is a default one
